    ...
    <section>
        <ul class="flex justify-between mx-2 my-1 flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400">
            <li @click="[switchChats('private'), router.push({name: 'private_chats'})]" class="w-[50%] cursor-pointer">
                <span v-if="chats == 'private'" aria-current="page" class="inline-block p-3 w-full text-blue-600 rounded-t-lg active bg-white shadow-md dark:bg-gray-800 dark:text-blue-500">Private chats</span>
            ...
            <li @click="[switchChats('team'), router.push({name: 'group_chats'})]" class="w-[50%] cursor-pointer">
                <span v-if="chats == 'team'" aria-current="page" class="inline-block p-3 w-full text-blue-600 rounded-t-lg active bg-white shadow-md dark:bg-gray-800 dark:text-blue-500">Group chats</span>
