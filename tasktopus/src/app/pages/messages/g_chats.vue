<template>
    <ol class="divide-y divide-gray-300 dark:divide-gray-800">
        <li class="cursor-pointer items-center p-2 flex hover:bg-gray-200 hover:shadow-md dark:hover:bg-gray-700">
            ...
            <div class="text-gray-600 dark:text-gray-400 flex-grow">
                <div class="flex justify-between items-start">
                    <span class="dark:text-gray-300 text-gray-500 font-semibold">@Group name</span>
                    <time class="min-w-[2.8rem] block text-end mb-1 text-xs font-normal text-gray-400 sm:order-last sm:mb-0">12:30</time>
                </div>
